...
function VehicleModel({ type, color }) {
  ...
  const bodyProps = (() => {
    switch (type) {
      ...
      case 'SUV':
        return {
          body: { position: [0, 0.55, 0], args: [2.3, 0.52, 1.05] },
          roof: { position: [0.15, 0.98, 0], args: [1.6, 0.36, 0.95] },
          windows: { position: [0.1, 0.98, 0], args: [1.4, 0.32, 0.86] },
          wheels: [
            [-1.1, 0.1, 0.65],
            [1.1, 0.1, 0.65],
            [1.1, 0.1, -0.65],
      ...
      default:
        return {
          body: { position: [0, 0.55, 0], args: [2.35, 0.48, 0.95] },
          roof: { position: [0.1, 0.95, 0], args: [1.5, 0.34, 0.82] },
          windows: { position: [0.12, 0.95, 0], args: [1.35, 0.32, 0.74] },
          wheels: [
            [-1.08, 0.1, 0.62],
            [1.08, 0.1, 0.62],
            [1.08, 0.1, -0.62],
